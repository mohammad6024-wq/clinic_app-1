...
class DashboardTab(QWidget):
    ...
    # ========== متد جدید برای رنگ جلسات ==========
        def get_session_color(self, session_count):
        # بررسی وضعیت فعال/غیرفعال هشدار از تب مراجعین
        enabled = True
    ...
    def show_notification(self):
        dialog = NotificationCenter(self)
        dialog.exec()
    
    def show_notification_for_appointment(self, appointment):
        dialog = NotificationCenter(self, specific_doctor=appointment.doctor)
        dialog.exec()
    ...
    def load_appointments(self):
        ...
        for i, app in enumerate(apps):
            ...
            # ستون تعداد جلسات با رنگ (طبق تعداد جلسات مراجع)
